...
I've written a R function that's available for download [here.](age_sex_adjust.R) The script can be sourced ( `source("age_sex_adjust.R")` ) and then the function `age_sex_adjust()` can be used as is. The code will also be described step by step below.
